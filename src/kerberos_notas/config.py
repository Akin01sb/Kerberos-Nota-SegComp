...
CHAVE_SECRETA_SERVICO_CHAT_BASE64 = "MjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjI="
...
CHAVE_SECRETA_SERVICO_CHAT = base64_para_bytes(CHAVE_SECRETA_SERVICO_CHAT_BASE64)
